    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float near = smoothstep(_ScanValue, linear01Depth, _ScanValue - _ScanLineWidth); // _ScanValue 就是 控制值, 在 [0, 1] 区间
                ...
                //float v = saturate(abs(_ScanValue - linear01Depth) / halfWidth); //线内返回(0, 1)，线外返回1
